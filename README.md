...
4. **Создать суперпользователя** (если нужен):
```bash
...
После выполнения команды `create_sample_data` будут доступны:
...
- Профили пользователей с аватарами и биографией

### ✅ Система курсов
- Три типа курсов: онлайн, офлайн, вебинары
- Категории и теги курсов
...
- Интерактивные страницы изучения уроков
- Система завершения курсов
...
- Расширенная Django админ-панель
- Массовые операции с курсами и пользователями
...
- Endpoints для курсов, пользователей, записей

### ✅ UI/UX
- Адаптивный дизайн в стиле MadTest
- Минималистичный интерфейс
- Интуитивная навигация
- Современные компоненты Bootstrap 5
...
- `GET /api/enrollments/` - Записи пользователя
